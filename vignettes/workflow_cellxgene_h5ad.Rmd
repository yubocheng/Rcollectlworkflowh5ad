...
rowData(sce)$Chr <- mapIds(EnsDb.Hsapiens.v86, keys=as.character(rowData(sce)$feature_name), column="SEQNAME", keytype="SYMBOL")

rownames(sce) <- as.character(rowData(sce)$feature_name)
