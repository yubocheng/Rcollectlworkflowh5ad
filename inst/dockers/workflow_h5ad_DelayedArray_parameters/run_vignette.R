...
rmarkdown::render("workflow_cellxgene_h5ad_DelayedArray_parameters.Rmd", output_dir = ".", params = list(knitr_eval=as.logical(args[1]), fileId=args[2], sample=args[3], mem_gb=as.integer(args[4])))
